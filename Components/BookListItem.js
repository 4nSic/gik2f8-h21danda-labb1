...
import {ListItemEventLiatner} from "../script/script.js"
'use strict'
export const BookListItem = (book) =>{
    ...
    li.addEventListener("mouseenter",ListItemEventLiatner)
    li.addEventListener("mouseleave",ListItemEventLiatner)
